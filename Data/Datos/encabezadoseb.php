...
$datos001=$items001->beneficiarios($_POST['ids']);
...
<div class="col-md-12">
			<div class="row">
				<div class="col-md-3">
                        ...
                        <input type="text" class="form-control form-control-sm  mb-3" name="Ficha" id="Ficha" value="<?php echo $datos001[$j][0]; ?>" readonly>
				</div>
				<div class="col-md-3">
                   ...
                   <option value="<?php echo $datos001[$j][2]; ?>"><?php echo $datos001[$j][20]; ?></option>
				...
				<div class="col-md-3">
                    ...
                    <input type="text" class="form-control form-control-sm  mb-3" name="afiliacion" id="afiliacion" value="<?php echo $datos001[$j][3]; ?>" readonly>
				</div>
				<div class="col-md-3">
                   ...
                   <option value="<?php echo $datos001[$j][4]; ?>"><?php echo $datos001[$j][22]; ?></option>
				...
				<div class="col-md-3">
					...
					<input type="text" class="form-control form-control-sm  mb-3" name="identificacion" id="identificacion" value="<?php echo $datos001[$j][5]; ?>">
				</div>
				<div class="col-md-3">
					 
					<label class="control-label" style="position:relative; top:7px;">1-Apellido:</label>
					<input type="text" class="form-control form-control-sm  mb-3" name="apellido1" id="apellido1" value="<?php echo $datos001[$j][7]; ?>">
				</div>
		  <div class="col-md-3">
					 
					<label class="control-label" style="position:relative; top:7px;">2-Apellido:</label>
					<input type="text" class="form-control form-control-sm  mb-3" name="apellido2" id="apellido2" value="<?php echo $datos001[$j][6]; ?>">
				</div>
				<div class="col-md-3">
					 
					<label class="control-label" style="position:relative; top:7px;">1-Nombre:</label>
					<input type="text" class="form-control form-control-sm  mb-3" name="nombre1" id="nombre1" value="<?php echo $datos001[$j][8]; ?>">
				</div>
				<div class="col-md-3">
					 
					<label class="control-label" style="position:relative; top:7px;">2-Nombre:</label>
					<input type="text" class="form-control form-control-sm  mb-3" name="nombre2" id="nombre2" value="<?php echo $datos001[$j][9]; ?>">

				</div>
				<div class="col-md-3">
					 
					<label class="control-label" style="position:relative; top:7px;">Dirección:</label>
					<input type="text" class="form-control form-control-sm  mb-3" name="direccion" id="direccion" value="<?php echo $datos001[$j][10]; ?>">
				</div>
				<div class="col-md-3">
                   ...
                   <option value="<?php echo $datos001[$j][11]; ?>"><?php echo $datos001[$j][24]; ?></option>
				...
				<div class="col-md-3">
                   ...
                   <option value="<?php echo $datos001[$j][12]; ?>"><?php echo $datos001[$j][27]; ?></option>
				...
				<div class="col-md-3">
					...
					<input type="text" class="form-control form-control-sm  mb-3" name="telefono" id="telefono" value="<?php echo $datos001[$j][13]; ?>">
                </div>
				<div class="col-md-3">
					 
					<label class="control-label" style="position:relative; top:7px;">FNacimiento:</label>
					<input type="date" class="form-control form-control-sm  mb-3" name="nacimiento" id="nacimiento" value="<?php echo $datos001[$j][14]; ?>">
                </div>
				<div class="col-md-3">
...
<!-- termina cuerpo demodal -->
          ...
          <div class="modal-footer">
          	<button type="button" class="btn btn-primary" id="btnactualiz1" name="btnactualiz1">Actualizar</button>
            <button type="button" class="btn btn-secondary" data-dismiss="modal">Cerrar</button>
          </div>
<div id="respuesta001"></div>

<script type="text/javascript">
		$("#btnactualiz1").click(function(){

		 var fomr1=$("#form_edt_nuv1").serialize();
		  $.ajax({
			...
			//$("#idBnf").load("Datos/encabezados.php"); 
