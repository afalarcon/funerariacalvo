...
<div class="col-md-12">
			<div class="row">
				...
				<div class="col-md-3">
					...
					<input type="text" class="form-control form-control-sm  mb-3" name="identificacion" id="identificacion"  placeholder="Ingrese la Identificación">
				</div>
				<div class="col-md-3">
					 
					<label class="control-label" style="position:relative; top:7px;">1-Apellido:</label>
					<input type="text" class="form-control form-control-sm  mb-3" name="apellido1" id="apellido1" placeholder="Primer Apellido" >
				</div>
		  <div class="col-md-3">
					 
					<label class="control-label" style="position:relative; top:7px;">2-Apellido:</label>
					<input type="text" class="form-control form-control-sm  mb-3" name="apellido2" id="apellido2" placeholder="Segundo Apellido">
				</div>
				<div class="col-md-3">
					 
					<label class="control-label" style="position:relative; top:7px;">1-Nombre:</label>
					<input type="text" class="form-control form-control-sm  mb-3" name="nombre1" id="nombre1" placeholder="Primer Nombre" >
				</div>
				<div class="col-md-3">
					 
					<label class="control-label" style="position:relative; top:7px;">2-Nombre:</label>
					<input type="text" class="form-control form-control-sm  mb-3" name="nombre2" id="nombre2" placeholder="Segundo Nombre" >

				</div>
				<div class="col-md-3">
					 
					<label class="control-label" style="position:relative; top:7px;">Dirección:</label>
					<input type="text" class="form-control form-control-sm  mb-3" name="direccion" id="direccion" placeholder="Ingrese la Dirección" >
				</div>
				<div class="col-md-3">
				...
				<div class="col-md-3">
					...
					<input type="text" class="form-control form-control-sm  mb-3" name="telefono" id="telefono" placeholder="Ingrese el Teléfono" >
                </div>
				<div class="col-md-3">
				...
				<div class="col-md-3">
              	...
              	<div class="col-md-3">
					...
					<label class="control-label" style="position:relative; top:7px;">Contrato:</label>
					<input type="text" class="form-control form-control-sm  mb-3" name="Interno" id="Interno" placeholder="Ingrese el # Contrato" >
              </div>
...
<script type="text/javascript">
  ...
  $.ajax({
	...
	$("#textdesc").focus();
	$("#idtable001").load("Datos/tabla_datos.php"); 
