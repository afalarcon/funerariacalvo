...
<div class="col-md-12">
			<div class="row">
				<div class="col-md-3">
						<label class="control-label" style="position:relative; top:7px;">Nro Interno:</label>
                        <input type="hidden" class="form-control form-control-sm  mb-3" name="Ficha" id="Ficha" value="<?php echo $datos001[$j][0]; ?>">
                        <input type="text" class="form-control form-control-sm  mb-3" name="Interno" id="Interno" value="<?php echo $datos001[$j][18]; ?>">
				</div>
				<div class="col-md-3">
                   ...
                   <option value="<?php echo $datos001[$j][1]; ?>"><?php echo $datos001[$j][20]; ?></option>
				...
				<div class="col-md-3">
                    ...
                    <input type="date" class="form-control form-control-sm  mb-3" name="afiliacion" id="afiliacion" value="<?php echo $datos001[$j][2]; ?>" >
				</div>
				<div class="col-md-3">
		  ...
		  <div class="col-md-3">
				...
				<div class="col-md-3">
                   ...
                   <option value="<?php echo $datos001[$j][10]; ?>"><?php echo $datos001[$j][24]; ?></option>
				...
				<div class="col-md-3">
                   ...
                   <option value="<?php echo $datos001[$j][11]; ?>"><?php echo $datos001[$j][27]; ?></option>
				...
				<div class="col-md-3">
					...
					<input type="date" class="form-control form-control-sm  mb-3" name="nacimiento" id="nacimiento" value="<?php echo $datos001[$j][13]; ?>">
                </div>
				<div class="col-md-3">
		...
		$("#btnactualiz").click(function(){
		 ...
		 var fomr1=$("#form_edt_nuv").serialize();
		  $.ajax({
			...
			$("#idtable001").load("datos/tabla_datos.php",data); 
