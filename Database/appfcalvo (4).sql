...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 25-06-2020 a las 18:43:56
...
--
ALTER TABLE `cierre`
  MODIFY `idCier` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=30;
...
--
ALTER TABLE `recibos`
  MODIFY `NroReci` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=291;
